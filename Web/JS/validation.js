                        ...
                        <div class="flex flex-wrap min-h-screen w-full content-center justify-center py-10 rounded-lg absolute z-40" id="ElderlyPopup">
                            <div class="flex flex-wrap content-top justify-center rounded-lg bg-gray-50 shadow-md w-[28rem] border border-red-400">
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <p class="text-black text-2xl text-center">Be Careful</p> 
                                </div>
                                <hr class="border-t-4 grey mt-2">
                                <br>
                                <div class="text-black h-32 mb-5 text-center">
                                    <p>There has been a lot of recent cases of scams</p>
                                    <p>Please be careful during withdrawals and transfers.</p>
                                    <br>
                                    <p>Thank you for your understanding.</p>
                                </div>
                                <button input type="button" value="Retry" class="rounded-md bg-gray-600 w-full py-4 text-center text-white cursor-pointer hover:bg-gray-700 transition ease-in-out delay-10 hover:scale-105 duration-150 " onclick="DismissCheckVision()">
